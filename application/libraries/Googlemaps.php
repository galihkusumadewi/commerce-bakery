...
class Googlemaps {
	...
	var $center						= "-7.75816404024322, 110.363031283781";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
